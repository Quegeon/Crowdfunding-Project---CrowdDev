<form method="POST" action="{{ route('management.company.update.password', $dataId) }}" id="changeCompanyPasswordForm" class="row g-3" autocomplete="off">
    @csrf
    @method('PUT')
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex justify-content-between align-items-center input-group">
                ...
                <div class="input-group-append">
                    <button type="button" id="toggle_visibility" class="btn justify-content-end" data-id="{{ $dataId->id }}" data-visibility="hide">
...
@vite('resources/assets/js/admin/manage-company/modal-change-password.js')

<script>
  $(document).ready(function(){
    FormValidation.formValidation(document.getElementById('changeCompanyPasswordForm'), {
      fields: {
        new_password: {
          validators: {
            notEmpty: {
