        ...
        <div id="company-details" class="content">
          <div class="row g-3">
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" value="{{ $ongoing }}" disabled />
            </div>
            <div class="col-sm-6">
              <label class="form-label">Finished Project</label>
              <input type="text" class="form-control" value="{{ $finished }}" disabled />
            </div>
            <div class="col-sm-12">
