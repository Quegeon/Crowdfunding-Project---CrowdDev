...
(function() {
    const wizardIconsModernVertical = document.querySelector('#add-company-wizard');
  
    if (typeof wizardIconsModernVertical !== undefined && wizardIconsModernVertical !== null) {
      // Wizard form
      const wizardValidationForm = wizardIconsModernVertical.querySelector('#addCompanyForm');
      // Wizard steps
